...
public class ClientHandle : MonoBehaviour
{
    ...
    //static TimeOfDays td = new TimeOfDays();
    static TimeOfDays TD;
    //public static Transform Light;
    //static TimeOfDays time = Light.GetComponent<TimeOfDays>();
    ...
    public static void TimeOfDay(Packet _packet)
    {
        ...
        // LM.UpdateLighting(tod);
        //TD.SetTime(tod);
        //Light.RotateAround(Vector3.zero, Vector3.right, 30f * tod);
